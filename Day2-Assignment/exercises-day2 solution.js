...
*/
console.log(sumOfArray([1, 4, 1, 5, 5, 5]));
console.log(sumOfArray([3, 1, 2, 5, 9.9, 5, 11, 2, 7, 3, 0, 9, 3, 4, 8, 5]));
...
var hypotenuse = Math.sqrt(Math.pow(shapes[2].base, 2) + Math.pow(shapes[2].height, 2));
